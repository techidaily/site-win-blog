---
title: Effective Strategies to Shrink Image-Based MS Office Files
date: 2024-08-28T05:41:28.861Z
updated: 2024-08-29T05:41:28.861Z
tags:
  - excel
categories:
  - tech
thumbnail: https://static1.howtogeekimages.com/wordpress/wp-content/uploads/2016/05/ofs_top-650x275.png
---

## Effective Strategies to Shrink Image-Based MS Office Files

### Quick Links

* [Compress Pictures in Your Office Document](https://techidaily.com/solved-bad-and-corrupt-videos-that-won-t-play-on-vivo-x90s-by-stellar-video-repair-mobile-video-repair/)
* [Remove Editing Information from Pictures](https://extra-support.techidaily.com/in-2024-instagrams-picture-perfect-upload-techniques-unveiled/)
...
##  Compress Pictures in Your Office Document
 ...
 The first step you should take in trying to reduce the file size of a document with pictures is to compress those pictures. Each Office app offers a handy tool for doing just that. We're using Word here (and that's what we'll refer to in the following steps), but you'll find the features in the same place in other Office apps.

 In your document, click any picture to select it. Click the Format menu that appears on the Office toolbar when you select a picture.

![ofs_1](https://static1.howtogeekimages.com/wordpress/wp-content/uploads/2016/05/ofs_1.png) 

 On the Format menu, click the Compress Pictures button.

![ofs_2](https://static1.howtogeekimages.com/wordpress/wp-content/uploads/2016/05/ofs_2.png) 

 In the Compress Pictures window, click "Apply only to this picture" if you want to compress only the picture you selected. When this option is not checked, your actions will apply to all pictures in the document. Select "Delete cropped areas of pictures" if you have cropped pictures in your document and want to remove the areas you've cropped out. Just note that if you select this option, you will not be able to undo the cropping later unless you reinsert the original picture. You can also choose a resolution to which to compress pictures. Choose the lowest resolution that will cover your needs. Click OK when you're done.

![ofs_3](https://static1.howtogeekimages.com/wordpress/wp-content/uploads/2016/05/ofs_3.png) 
...
##  Remove Editing Information from Pictures
 ...
 With your document open, click the File menu.
